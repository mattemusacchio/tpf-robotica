...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/launch', [
            ...
            'launch/red_cone_detector.launch.py',
        ]),
        ('share/' + package_name + '/config', [
            'config/aruco_detector.yaml',
            'config/red_cone_detector.yaml',
        ]),
    ],
    ...
    entry_points={
        'console_scripts': [
            ...
            'red_cone_detector_node = tpf_perception.red_cone_detector_node:main',
        ],
    },
)
